# Generated by Django 4.0.3 on 2022-03-02 16:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.ForeignKey(help_text='The character who said this.', on_delete=django.db.models.deletion.CASCADE, to='django_quotes.character')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            bases=(rules.contrib.models.RulesModelMixin, models.Model),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='stats', to='django_quotes.charactergroup')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.OneToOneField(help_text='The character group this model belongs to.', on_delete=django.db.models.deletion.CASCADE, to='django_quotes.charactergroup')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quotes_requested', models.PositiveIntegerField(default=0, help_text='Number of time child quotes have been requested.')),
                ('quotes_generated', models.PositiveIntegerField(default=0, help_text='Number of times markov generated quotes have been requested.')),
                ('character', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='stats', to='django_quotes.character')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='django_quotes.character')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(help_text='The group this character belongs to.', on_delete=django.db.models.deletion.CASCADE, to='django_quotes.charactergroup'),
        ),
        migrations.AddField(
            model_name='character',
            name='owner',
